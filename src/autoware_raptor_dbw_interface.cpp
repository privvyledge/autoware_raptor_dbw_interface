...
//      m_dbw_state_machine(new DbwStateMachine{3}),
...

      {
          ...
          control_cmd_sub_ = node.create_subscription<autoware_auto_control_msgs::msg::AckermannControlCommand>(
            "/control/command/control_cmd", 1, std::bind(&RaptorDBWInterface::callback_control_cmd, this, _1));
          ...
          m_timer = node.create_wall_timer(m_pub_period, std::bind(&RaptorDBWInterface::to_vehicle, this));
      }

      void RaptorDBWInterface::callback_control_cmd(
          const autoware_auto_control_msgs::msg::AckermannControlCommand::ConstSharedPtr msg)
            {
              control_cmd_ptr_ = msg;
            }

      void RaptorDBWInterface::to_vehicle()
        {
      ...
      bool8_t RaptorDBWInterface::send_state_command(const VehicleStateCommand & msg)
        {
      ...
      bool8_t RaptorDBWInterface::send_control_command(const HighLevelControlCommand & msg)
        {
      ...
      bool8_t RaptorDBWInterface::send_control_command(const VehicleControlCommand & msg)
        {

        }

      bool8_t RaptorDBWInterface::send_control_command(const AckermannControlCommand & msg)
        {

        }

      bool8_t RaptorDBWInterface::handle_mode_change_request(ModeChangeRequest::SharedPtr request)
        {

        }

      void RaptorDBWInterface::send_headlights_command(const HeadlightsCommand & msg)
        {

        }

      void RaptorDBWInterface::send_horn_command(const HornCommand & msg)
        {
          // Set misc command values
        }

      void RaptorDBWInterface::send_wipers_command(const WipersCommand & msg)
        {

        }

      void RaptorDBWInterface::on_brake_report(const BrakeReport::SharedPtr & msg)
        {

        }

      void RaptorDBWInterface::on_gear_report(const GearReport::SharedPtr & msg)
        {

        }

      void RaptorDBWInterface::on_misc_report(const MiscReport::SharedPtr & msg)
        {

        }

      void RaptorDBWInterface::on_other_actuators_report(const OtherActuatorsReport::SharedPtr & msg)
        {

        }

      void RaptorDBWInterface::on_steering_report(const SteeringReport::SharedPtr & msg)
        {

        }

      void RaptorDBWInterface::on_wheel_spd_report(const WheelSpeedReport::SharedPtr & msg)
        {

        }

      // Update x, y, heading, and heading_rate
      void RaptorDBWInterface::kinematic_bicycle_model(
